...
public class ElementUtil {
	...
	private JsUtil jsutility;

	public ElementUtil(WebDriver driver) {
		this.driver = driver;
		jsutility = new JsUtil(driver);
	}
	
	private boolean isHighlight() {
		if(Boolean.parseBoolean(DriverFactory.isHighLight)) return true;
		return false;
	}
	...
	public WebElement getElement(By locator) {
		...
		if(isHighlight()) jsutility.flash(elmnt);
		return elmnt;
	}
	...
	@Step("Get all the elements {0} having text visible")
